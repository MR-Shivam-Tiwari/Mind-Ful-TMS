            ...
            <div class="mt-1  flex  items-center justify-center bg-background text-foreground">
                <div class="w-full max-w-md bg-card  rounded-lg lg:container p-6">
                    <div class="flex items-center   mb-6">
                        <div className='mr-4' onClick={() => navigate('/appointment')}>
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-center ">Appointment details!</h1>

                        </div>
                    </div>
                    <p class="text-center text-primary-orange text-md mb-8">Book your appointment in a few simple steps, See you soon!</p>
                    <div class="space-y-6">
                        <div class="flex items-center justify-between p-3 bg-primary-div rounded-lg shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex items-center justify-between p-5 bg-primary-div rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            <div class="flex items-center space-x-4">
                    ...
                    <div className='flex items-center justify-center'>
                        ...
                        <button class=" w-full mt-8 py-4 bg-primary-orange px-10  rounded-lg  text-white font-semibold" onClick={() => navigate("/summary")}>BOOK APPOINTMENT</button>
                    </div>
                </div>
            </div>
        </div>
