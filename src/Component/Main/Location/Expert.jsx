        ...
        <div className='select-none'>
            <div class="p-7 max-w-md mx-auto lg:container">
                <div class="flex items-center ">
                    <div className='mb-6'>
                        <div className='mr-4 cursor-pointer' onClick={() => navigate('/assistance')}>
                ...
                <div class="flex items-center bg-primary-div active:bg-orange-100 hover:bg-orange-200 p-3 bg-card rounded-lg shadow" onClick={()=> navigate("/appointment")}>
